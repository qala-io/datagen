...
public class CommonsLang3RandomStringUtilsTest {
    ...
    public void testConstructor() {
        assertNotNull(new CommonsLang3RandomStringUtils());
        final Constructor<?>[] cons = CommonsLang3RandomStringUtils.class.getDeclaredConstructors();
        assertEquals(1, cons.length);
        assertTrue(Modifier.isPublic(cons[0].getModifiers()));
        assertTrue(Modifier.isPublic(CommonsLang3RandomStringUtils.class.getModifiers()));
        assertFalse(Modifier.isFinal(CommonsLang3RandomStringUtils.class.getModifiers()));
    }
    ...
    public void testLANG805() {
        final long seed = System.currentTimeMillis();
        assertEquals("aaa", CommonsLang3RandomStringUtils.random(3,0,0,false,false,new char[]{'a'},new Random(seed)));
    }

    @Test
    public void testLANG807() {
        try {
            CommonsLang3RandomStringUtils.random(3,5,5,false,false);
    ...
    public void testRandomAlphaNumeric() {
        ...
        for (int i = 0; i < 100; i++) {
            final String randString = CommonsLang3RandomStringUtils.randomAlphanumeric(10);
    ...
    public void testRandomNumeric() {
        ...
        for (int i = 0; i < 100; i++) {
            final String randString = CommonsLang3RandomStringUtils.randomNumeric(10);
            for (int j = 0; j < testChars.length; j++) {
                if (randString.indexOf(testChars[j]) > 0) {
                    found[j] = true;
                }
    ...
    public void testRandomAlphabetic() {
        ...
        for (int i = 0; i < 100; i++) {
            final String randString = CommonsLang3RandomStringUtils.randomAlphabetic(10);
            for (int j = 0; j < testChars.length; j++) {
                if (randString.indexOf(testChars[j]) > 0) {
                    found[j] = true;
                }
    ...
    public void testRandomAscii() {
        ...
        final boolean[] found = {false, false};
        for (int i = 0; i < 100; i++) {
            final String randString = CommonsLang3RandomStringUtils.randomAscii(10);
            for (int j = 0; j < testChars.length; j++) {
                if (randString.indexOf(testChars[j]) > 0) {
                    found[j] = true;
                }
    ...
    public void testCommonsLang3RandomStringUtilsHomog() {
        ...
        for (int i = 0; i< 100; i++) {
           gen = CommonsLang3RandomStringUtils.random(6,chars);
           for (int j = 0; j < 6; j++) {
               switch (gen.charAt(j)) {
    ...
    /**
     * Checks if the string got by {@link CommonsLang3RandomStringUtils#random(int)}
    ...
    public void testLang100() {
        ...
        final String orig = CommonsLang3RandomStringUtils.random(size);
